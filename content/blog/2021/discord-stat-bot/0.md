---
title: "discord.js를 활용한 메시지 통계 봇 만들기"
...
이상의 조건이 만족되면 `runCommand`로 명령어를 실행합니다. 이 함수가 하는 일에 대해서는 다음 장에서 자세히 설명하도록 하해습니다.
...
Nightbot, StreamElements 등 훨씬 완성도있고 기능들이 다양한 봇에 비하면 아직 개선할 점이 많은 봇입니다. 부족 글이지만 디스코드 봇을 만드는데 작게나마 도움이 되었으면 좋겠습니다.